...
export const songs: SeedSong[] = [
  {
    ...
    analysis: {
      mood: ["Longing", "Tender", "Melancholic"],
      themes: ["Farewell", "Devotion", "Mortality"],
      language: "en",
    },
    cyaniteStatus: "finished",
    cyaniteAnalysis: {
      genreTags: ["folk", "traditional", "ballad"],
      moodTags: ["sentimental", "melancholic", "romantic"],
      bpm: 68,
      musicalKey: "fMajor",
      energyLevel: "low",
      energyDynamics: "steady",
      valence: 0.3,
      arousal: 0.22,
      caption:
        "A tender orchestral ballad carried by a soaring contralto, aching with farewell.",
      era: "1910s",
      genre: { folk: 0.58, classical: 0.27, traditional: 0.15 },
      mood: { sentimental: 0.42, melancholic: 0.33, romantic: 0.25 },
  ...
  },
  {
    ...
    analysis: {
      mood: ["Hopeful", "Reverent", "Uplifting"],
      themes: ["Deliverance", "Faith", "Homecoming"],
      language: "en",
    },
    cyaniteStatus: "finished",
    cyaniteAnalysis: {
      genreTags: ["gospel", "spiritual", "aCappella"],
      moodTags: ["uplifting", "peaceful", "devotional"],
      bpm: 72,
      musicalKey: "gMajor",
      energyLevel: "medium",
      energyDynamics: "steady",
      ...
      arousal: 0.4,
      caption:
        "Four-part a cappella harmony rising in a calm, devotional spiritual of deliverance.",
      era: "1900s",
      genre: { gospel: 0.55, traditional: 0.25, soul: 0.2 },
      mood: { peaceful: 0.4, uplifting: 0.35, devotional: 0.25 },
      analyzedAt: "2026-06-15T12:00:00.000Z",
    },
  },
  {
    ...
    analysis: {
      mood: ["Wistful", "Bluesy", "Regretful"],
      themes: ["Heartbreak", "Regret", "Loss"],
      language: "en",
    },
    cyaniteStatus: "finished",
    cyaniteAnalysis: {
      genreTags: ["jazz", "vintagePop", "blues"],
      moodTags: ["bittersweet", "nostalgic", "melancholic"],
      bpm: 96,
      musicalKey: "cMajor",
      energyLevel: "medium",
      energyDynamics: "dynamic",
      valence: 0.4,
      arousal: 0.5,
      caption:
        "A bittersweet early-jazz lament for a love walking out the door, sung with knowing ache.",
      era: "1910s",
      genre: { jazz: 0.5, blues: 0.28, pop: 0.22 },
      mood: { bittersweet: 0.4, nostalgic: 0.32, melancholic: 0.28 },
      analyzedAt: "2026-06-15T12:00:00.000Z",
    },
  },
  {
    ...
    analysis: {
      mood: ["Defiant", "Playful", "Bold"],
      themes: ["Warning", "Independence", "Desire"],
      language: "en",
    },
    cyaniteStatus: "finished",
    cyaniteAnalysis: {
      genreTags: ["jazz", "vaudeville", "ragtime"],
      moodTags: ["sassy", "energetic", "confident"],
      bpm: 120,
      musicalKey: "fMajor",
      energyLevel: "high",
      energyDynamics: "dynamic",
      ...
      arousal: 0.72,
      caption:
        "A brassy, strutting vaudeville number delivered with red-hot confidence and swing.",
      era: "1910s",
      genre: { jazz: 0.48, ragtime: 0.3, pop: 0.22 },
      mood: { confident: 0.4, energetic: 0.35, playful: 0.25 },
      analyzedAt: "2026-06-15T12:00:00.000Z",
    },
  },
  {
    ...
    analysis: {
      mood: ["Soulful", "Aching", "Resolute"],
      themes: ["Heartache", "Longing", "Resilience"],
      language: "en",
    },
    cyaniteStatus: "finished",
    cyaniteAnalysis: {
      genreTags: ["blues", "classicBlues", "jazz"],
      moodTags: ["soulful", "melancholic", "gritty"],
      bpm: 84,
      musicalKey: "gMajor",
      energyLevel: "medium",
      energyDynamics: "dynamic",
      ...
      arousal: 0.55,
      caption:
        "Smoldering classic blues with a cornet's cry behind a powerhouse, world-weary vocal.",
      era: "1920s",
      genre: { blues: 0.6, jazz: 0.28, soul: 0.12 },
      mood: { soulful: 0.4, melancholic: 0.35, gritty: 0.25 },
      analyzedAt: "2026-06-15T12:00:00.000Z",
    },
  },
];
