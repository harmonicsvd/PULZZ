...
- [video-js scaffold missing DOM lib](video-js-tsconfig-dom-lib.md) — new video-js artifact tsconfig omits "lib"; add ["esnext","dom","dom.iterable"] or scaffold files fail typecheck (app still runs in Vite)
...
- [lucide Feather icon trap](lucide-feather-icon-trap.md) — `<Feather name="x"/>` ignores name and renders a literal feather everywhere; use named lucide imports, not a generic icon-by-name component
